...
import { ReversePipe, UTCDatePipe } from './pipes/reverse.pipe';
...
@NgModule({
  ...
  entryComponents: [ ModaltemplateComponent, ConfirmationDialogComponent, FlaggedInputDialogComponent ]
